...
class CustomizeCusCard1 extends StatefulWidget {
  const CustomizeCusCard1({super.key});

  @override
  _CustomizeCusCard1State createState() => _CustomizeCusCard1State();
}

class _CustomizeCusCard1State extends State<CustomizeCusCard1> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/special.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
