...
class CustomizeCusCard6 extends StatefulWidget {
  const CustomizeCusCard6({super.key});

  @override
  _CustomizeCusCard6State createState() => _CustomizeCusCard6State();
}

class _CustomizeCusCard6State extends State<CustomizeCusCard6> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/student4.jpeg'),
            fit: BoxFit.fill,
          ),
        ),
        child: Column(
