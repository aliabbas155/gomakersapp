...
class CustomizeCusCard10 extends StatefulWidget {
  const CustomizeCusCard10({super.key});

  @override
  _CustomizeCusCard10State createState() => _CustomizeCusCard10State();
}

class _CustomizeCusCard10State extends State<CustomizeCusCard10> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/customimage3.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
