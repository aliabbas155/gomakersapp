...
class CustomizeCusCard9 extends StatefulWidget {
  const CustomizeCusCard9({super.key});

  @override
  _CustomizeCusCard9State createState() => _CustomizeCusCard9State();
}

class _CustomizeCusCard9State extends State<CustomizeCusCard9> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/customimage2.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
