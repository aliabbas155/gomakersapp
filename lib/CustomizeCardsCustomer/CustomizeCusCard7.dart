...
class CustomizeCusCard7 extends StatefulWidget {
  const CustomizeCusCard7({super.key});

  @override
  _CustomizeCusCard7State createState() => _CustomizeCusCard7State();
}

class _CustomizeCusCard7State extends State<CustomizeCusCard7> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/university5.jpeg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
