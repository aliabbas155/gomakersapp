...
class CustomizeCusCard2 extends StatefulWidget {
  const CustomizeCusCard2({super.key});

  @override
  _CustomizeCusCard2State createState() => _CustomizeCusCard2State();
}

class _CustomizeCusCard2State extends State<CustomizeCusCard2> {
