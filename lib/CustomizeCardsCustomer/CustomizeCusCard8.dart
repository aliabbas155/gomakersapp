...
class CustomizeCusCard8 extends StatefulWidget {
  const CustomizeCusCard8({super.key});

  @override
  _CustomizeCusCard8State createState() => _CustomizeCusCard8State();
}

class _CustomizeCusCard8State extends State<CustomizeCusCard8> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/customeimage1.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
