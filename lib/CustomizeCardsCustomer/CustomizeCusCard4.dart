...
class CustomizeCusCard4 extends StatefulWidget {
  const CustomizeCusCard4({super.key});

  @override
  _CustomizeCusCard4State createState() => _CustomizeCusCard4State();
}

class _CustomizeCusCard4State extends State<CustomizeCusCard4> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/insurance1.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
