...
class CustomizeCusCard5 extends StatefulWidget {
  const CustomizeCusCard5({super.key});

  @override
  _CustomizeCusCard5State createState() => _CustomizeCusCard5State();
}

class _CustomizeCusCard5State extends State<CustomizeCusCard5> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/school5.jpeg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
