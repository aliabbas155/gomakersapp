...
class CustomizeBcard6 extends StatefulWidget {
  const CustomizeBcard6({
    super.key,
  });

  @override
  _CustomizeBcard6State createState() => _CustomizeBcard6State();
}

class _CustomizeBcard6State extends State<CustomizeBcard6> {
