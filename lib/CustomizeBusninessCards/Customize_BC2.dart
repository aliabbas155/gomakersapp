...
class CustomizeBcard2 extends StatefulWidget {
  const CustomizeBcard2({
    super.key,
  });

  @override
  State<CustomizeBcard2> createState() => _CustomizeBcard2State();
}

class _CustomizeBcard2State extends State<CustomizeBcard2> {
