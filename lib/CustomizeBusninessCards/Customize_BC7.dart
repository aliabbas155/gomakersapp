...
class CustomizeBcard7 extends StatefulWidget {
  const CustomizeBcard7({
    super.key,
  });

  @override
  _CustomizeBcard7State createState() => _CustomizeBcard7State();
}

class _CustomizeBcard7State extends State<CustomizeBcard7> {
