...
import 'package:gomakersapp/ProfileData/CustomerProfile.dart';
import 'package:gomakersapp/UpdateProfile/customerupdateprofile.dart';
import 'package:gomakersapp/UpdateProfile/deletecustomprofile.dart';
...
class _AppDrawerState extends State<AppDrawer> {
  ...
  void _onShare(BuildContext context) async {
    ...
    String linkToShare =
        "https://www.au.edu.pk/"; // Replace with your actual link
            ...
            onTap: () {
              Navigator.of(context).push(PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) =>
                    FadeTransition(
                  opacity: animation,
                  child: const CustomerUpdateProfile(),
                ),
                transitionDuration: const Duration(
                  seconds: 1,
                ),
            ...
            onTap: () {
              Navigator.of(context).push(PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) =>
                    FadeTransition(
                  opacity: animation,
                  child: const DeleteCustomerProfile(),
                ),
                transitionDuration: const Duration(
                  seconds: 1,
                ),
