...
class BusinessCard8 extends StatefulWidget {
  const BusinessCard8({
    super.key,
  });

  @override
  _BusinessCard8State createState() => _BusinessCard8State();
}

class _BusinessCard8State extends State<BusinessCard8> {
  late DocumentSnapshot? data;
  bool isEditingEnabled = false;
  String? profileImageUrl;
  String currentFontFamily = 'DefaultFont';
  Color currentFontColor = Colors.white; // Set an initial font family

  List<String> backgroundImageList = [
    'assets/images/customeimage1.jpg',
    'assets/images/university2.jpeg',
    'assets/images/university4.jpeg',
