...
class BusinessCard6 extends StatefulWidget {
  const BusinessCard6({
    super.key,
  });

  @override
  _BusinessCard6State createState() => _BusinessCard6State();
}

class _BusinessCard6State extends State<BusinessCard6> {
