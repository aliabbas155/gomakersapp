...
class BusinessCard10 extends StatefulWidget {
  const BusinessCard10({
    super.key,
  });

  @override
  _BusinessCard10State createState() => _BusinessCard10State();
}

class _BusinessCard10State extends State<BusinessCard10> {
