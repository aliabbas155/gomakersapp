...
class BusinessCard7 extends StatefulWidget {
  const BusinessCard7({
    super.key,
  });

  @override
  _BusinessCard7State createState() => _BusinessCard7State();
}

class _BusinessCard7State extends State<BusinessCard7> {
  ...
  List<String> backgroundImageList = [
    'assets/images/university1.jpeg',
