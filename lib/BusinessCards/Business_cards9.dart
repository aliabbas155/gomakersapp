...
class BusinessCard9 extends StatefulWidget {
  const BusinessCard9({
    super.key,
  });

  @override
  _BusinessCard9State createState() => _BusinessCard9State();
}

class _BusinessCard9State extends State<BusinessCard9> {
  ...
  List<String> backgroundImageList = [
    'assets/images/customimage2.jpg',
