...
class CustomerCard9 extends StatefulWidget {
  const CustomerCard9({super.key});

  @override
  _CustomerCard9State createState() => _CustomerCard9State();
}

class _CustomerCard9State extends State<CustomerCard9> {
