...
class CustomerCard4 extends StatefulWidget {
  const CustomerCard4({super.key});

  @override
  _CustomerCard4State createState() => _CustomerCard4State();
}

class _CustomerCard4State extends State<CustomerCard4> {
