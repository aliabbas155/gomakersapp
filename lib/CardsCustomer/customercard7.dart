...
class CustomerCard7 extends StatefulWidget {
  const CustomerCard7({super.key});

  @override
  _CustomerCard7State createState() => _CustomerCard7State();
}

class _CustomerCard7State extends State<CustomerCard7> {
