...
class CustomerCard5 extends StatefulWidget {
  const CustomerCard5({super.key});

  @override
  _CustomerCard5State createState() => _CustomerCard5State();
}

class _CustomerCard5State extends State<CustomerCard5> {
