...
class CustomerCard10 extends StatefulWidget {
  const CustomerCard10({super.key});

  @override
  _CustomerCard10State createState() => _CustomerCard10State();
}

class _CustomerCard10State extends State<CustomerCard10> {
