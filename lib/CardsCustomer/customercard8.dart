...
class CustomerCard8 extends StatefulWidget {
  const CustomerCard8({super.key});

  @override
  _CustomerCard8State createState() => _CustomerCard8State();
}

class _CustomerCard8State extends State<CustomerCard8> {
