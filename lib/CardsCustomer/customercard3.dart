...
class CustomerCard3 extends StatefulWidget {
  const CustomerCard3({super.key});

  @override
  _CustomerCard3State createState() => _CustomerCard3State();
}

class _CustomerCard3State extends State<CustomerCard3> {
