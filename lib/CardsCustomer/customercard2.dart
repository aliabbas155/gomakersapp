...
class CustomerCard2 extends StatefulWidget {
  const CustomerCard2({super.key});

  @override
  _CustomerCard2State createState() => _CustomerCard2State();
}

class _CustomerCard2State extends State<CustomerCard2> {
