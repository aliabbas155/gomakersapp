...
class CutomerImageWidget extends StatefulWidget {
  const CutomerImageWidget({super.key});

  @override
  _CutomerImageWidgetState createState() => _CutomerImageWidgetState();
}

class _CutomerImageWidgetState extends State<CutomerImageWidget> {
