...
class CustomerCard1 extends StatefulWidget {
  const CustomerCard1({super.key});

  @override
  _CustomerCard1State createState() => _CustomerCard1State();
}

class _CustomerCard1State extends State<CustomerCard1> {
