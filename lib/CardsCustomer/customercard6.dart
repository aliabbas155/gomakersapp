...
class CustomerCard6 extends StatefulWidget {
  const CustomerCard6({super.key});

  @override
  _CustomerCard6State createState() => _CustomerCard6State();
}

class _CustomerCard6State extends State<CustomerCard6> {
